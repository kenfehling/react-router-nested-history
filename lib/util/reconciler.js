...
exports.diffPagesToSteps = exports.createSteps = void 0;
 ...
 */
var diffPagesToSteps = function (ps1, ps2) {
    ...
    var simple = function () {
        if (diff.added.length > 0) {
            ...
            return __spreadArray(__spreadArray([], pushes, true), backs, true);
        }
        else {
    ...
    var complex = function () {
        var cleanWipe = function () {
            ...
            return __spreadArray(__spreadArray(__spreadArray([], backs1, true), pushes, true), backs2, true);
        };
        var removeFwdHistory = function () {
            return __spreadArray(__spreadArray([], backSteps(1), true), [pushStep(pageUtils.getActivePage(ps2))], false);
            /*
...
exports.diffPagesToSteps = diffPagesToSteps;
