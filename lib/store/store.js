...
exports.createStore = exports.deriveState = void 0;
...
function createStore(_a) {
    ...
    function loadActions() {
        if (store.enabled) {
            ...
            if (objects) {
                actions = objects.map(function (obj) { return (0, serializer_1.deserialize)(obj); });
            }
        }
    }
    function init() {
    ...
    function _dispatch(action) {
        ...
        if (store.enabled) { // if can use localStorage
            store.set('actions', actions.map(function (a) { return (0, serializer_1.serialize)(a); }));
        }
    }
    function dispatch(action) {
        if (action instanceof Action_1.default) { // it's a class object
    ...
    function getState() {
        return __assign(__assign(__assign({}, Object(storedComputedState)), { isInitialized: storedRawState.isInitialized, loadedFromPersist: loadFromPersist, actions: actions }), (regularReduxStore ? regularReduxStore.getState() : {}));
    }
