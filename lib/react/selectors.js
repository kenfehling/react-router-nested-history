...
exports.createDeepEqualSelector = reselect_1.createSelectorCreator(reselect_1.defaultMemoize, _.isEqual);
exports.createCachingSelector = reselect_1.createSelectorCreator(_.memoize, function (a, b) { return a === b; });
exports.EMPTY_OBJ = {};
...
exports.getLastAction = function (state) { return _.last(state.actions.filter(function (a) {
