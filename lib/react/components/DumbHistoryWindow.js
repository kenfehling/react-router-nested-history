...
var DumbHistoryWindow = (function (_super) {
    ...
    DumbHistoryWindow.prototype.render = function () {
        ...
        return (React.createElement("div", __assign({ className: this.getClassName(), onMouseDown: this.onMouseDown.bind(this) }, divProps, { style: __assign({}, style, { zIndex: zIndex, position: 'absolute', top: top ? top + 'px' : '', left: left ? left + 'px' : '', visibility: storedVisible ? 'visible' : 'hidden' }) }), children instanceof Function ? children({ open: open, close: close }) : children));
    };
