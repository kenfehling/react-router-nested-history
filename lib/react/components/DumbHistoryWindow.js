...
var DumbHistoryWindow = (function (_super) {
    ...
    DumbHistoryWindow.prototype.render = function () {
        var _a = R.omit([
            ...
            'topClassName',
            'storeSubscription'
        ], this.props), forName = _a.forName, top = _a.top, left = _a.left, children = _a.children, _b = _a.style, style = _b === void 0 ? {} : _b, stackOrder = _a.stackOrder, storedVisible = _a.storedVisible, open = _a.open, close = _a.close, divProps = __rest(_a, ["forName", "top", "left", "children", "style", "stackOrder", "storedVisible", "open", "close"]);
        var zIndex = getWindowZIndex(stackOrder, forName);
        return (React.createElement("div", __assign({ className: this.getClassName(), onMouseDown: this.onMouseDown.bind(this) }, divProps, { style: __assign({}, style, { zIndex: zIndex, position: 'absolute', top: top ? top + 'px' : '', left: left ? left + 'px' : '', visibility: storedVisible ? 'visible' : 'hidden' }) }), children instanceof Function ? children({ open: open, close: close, zIndex: zIndex }) : children));
    };
