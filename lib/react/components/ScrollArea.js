...
var ScrollArea = (function (_super) {
    ...
    ScrollArea.prototype.render = function () {
        ...
        return (React.createElement("div", __assign({ ref: function (ref) { return _this.scrollArea = ref; }, onScroll: this.onScroll.bind(this) }, divProps, { style: __assign({}, style, { width: '100%', height: '100%', overflowX: horizontal ? 'scroll' : 'auto', overflowY: vertical ? 'scroll' : 'auto', WebkitOverflowScrolling: 'touch' }) }), children));
    };
    return ScrollArea;
}(react_1.Component));
