...
var RegisterMatch = function (_Component) {
  _inherits(RegisterMatch, _Component);
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          { match: match },
          children ? children(_extends({ matched: !!match }, props)) : match ? render ? render(props) : React.createElement(Component, props) : null
        )
      );
    }
  }]);
