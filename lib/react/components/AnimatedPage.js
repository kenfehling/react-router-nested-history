...
var InnerAnimatedPage = (function (_super) {
    ...
    InnerAnimatedPage.prototype.render = function () {
        ...
        if (animate !== false) {
            return (React.createElement(react_router_transition_1.RouteTransition, { pathname: pathname, runOnMount: false, atEnter: willEnter(lastAction), atLeave: willLeave(lastAction), atActive: { offset: 0 }, mapStyles: function (styles) { return ({
