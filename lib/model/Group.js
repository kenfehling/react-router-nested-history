...
var Group = (function () {
    ...
    */
    ...
    Group.prototype.computeWindow = function () {
        return {
            forName: this.name,
            visible: this.enabled
        };
    };
    Group.prototype._computeWindows = function () {
        if (this.associatedWindow) {
            return immutable_1.fromJS({}).set(this.name, this.computeWindow());
        }
        else {
            return immutable_1.fromJS({});
        }
    };
    Group.prototype.computeWindows = function () {
        return immutable_1.fromJS({}).merge(this._computeWindows(), this.containers.reduce(function (map, c) {
            return immutable_1.fromJS({}).merge(map, c.computeWindows());
        }, immutable_1.fromJS({})));
    };
    return Group;
}());
